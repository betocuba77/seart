...
class User_model extends BF_Model
{
    ...
    public function prep_data($post_data) {
		...
		$data['surname'] = $post_data['surname'];
		if (!empty($post_data['carrera'])) {
			$data['carrera'] = $post_data['carrera'];
		}
		if (!empty($post_data['equipo_trabajo'])) {
			$data['equipo_trabajo'] = $post_data['equipo_trabajo'];
		}
		if (!empty($post_data['cargo'])) {
			$data['cargo'] = $post_data['cargo'];
		}
