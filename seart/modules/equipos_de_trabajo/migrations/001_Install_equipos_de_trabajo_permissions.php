...
class Migration_Install_equipos_de_trabajo_permissions extends Migration
{
	...
	private $permission_values = array(
		array(
			'name' => 'Equipos_de_Trabajo.Tutorias.View',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Equipos_de_Trabajo.Tutorias.Create',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Equipos_de_Trabajo.Tutorias.Edit',
			'description' => '',
			'status' => 'active',
		),
		array(
			'name' => 'Equipos_de_Trabajo.Tutorias.Delete',
			'description' => '',
			'status' => 'active',
		),
	);
