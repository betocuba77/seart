		...
		<table class="table table-striped">
			...
			<tbody>
				...
				<?php endif; ?>
					...
					<td><a href="<?php echo base_url().'index.php/admin/analisis/entrevistas/riesgos/'.$record->tutorando_id; ?>" class="btn btn-primary"><i class= "icon-eye-open icon-white"></i> Ver riesgos >></a></td>
				</tr>
				<?php
					endforeach;
				else:
